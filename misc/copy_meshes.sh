...
file_list_file="/home/budvin/research/Partitioning/paralab-partition/misc/connected_meshes_hex.txt"
...
for file_idx in {0..20}; do 
    ...
    scp ${mesh_file_list[$file_idx]} budvin@frontera.tacc.utexas.edu:/work2/10000/budvin/frontera/datasets/Meshes/10k_hex/
done