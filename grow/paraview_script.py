...
# method_names = ['SFC_morton', 'METIS' ,'BFS','Modified BFS (grow)']
method_names = ['SFC_morton','METIS','BFS','BFS_grow']

# file_names = ['coil.msh___SFC_morton.vtk','coil.msh___METIS.vtk','coil.msh___BFS.vtk','coil.msh___BFS_grow.vtk']
